defmodule Lynxplanningpoker.MixProject do
  use Mix.Project
  ...
  def application do
    [
      mod: {Lynxplanningpoker.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind lynxplanningpoker", "esbuild lynxplanningpoker"],
      "assets.deploy": [
        "tailwind lynxplanningpoker --minify",
