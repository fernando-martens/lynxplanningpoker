defmodule LynxplanningpokerWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      # Locale-aware URL helpers (localized_path/2, bcp47/1, ...)
      import LynxplanningpokerWeb.Locales
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: LynxplanningpokerWeb.Router,
        statics: LynxplanningpokerWeb.static_paths()
    end
  end
