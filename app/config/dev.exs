...
config :lynxplanningpoker, Lynxplanningpoker.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "lynxplanningpoker_dev",
  stacktrace: true,
...
config :lynxplanningpoker, LynxplanningpokerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "gnT/DSeDTHViEGe8Os2UDGOXm4swDEPJZIFq5Nc8qT+eSSd6Vl1RHU+b2usZSZTo",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:lynxplanningpoker, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:lynxplanningpoker, ~w(--watch)]}
  ]
...
config :lynxplanningpoker, LynxplanningpokerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/lynxplanningpoker_web/router\.ex$"E,
      ~r"lib/lynxplanningpoker_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :lynxplanningpoker, dev_routes: true
